 ...
 * Thresholds: EXCELLENT>=780, GOOD>=720, FAIR>=660, POOR>=600.
 * DTI multiplier: 250. Util multiplier: 200.
 */
@Component
public class ConservativeScoringStrategy implements ScoringStrategy {

    private static final int WEIGHT_BUREAU = 35;
    private static final int WEIGHT_DTI = 35;
    private static final int WEIGHT_UTILIZATION = 15;
    private static final int WEIGHT_EMPLOYMENT = 15;
